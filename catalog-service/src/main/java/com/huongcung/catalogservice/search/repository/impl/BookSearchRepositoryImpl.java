package com.huongcung.catalogservice.search.repository.impl;

import com.huongcung.catalogservice.search.config.SolrConfig;
...
public class BookSearchRepositoryImpl implements BookSearchRepository {
    ...
    private SolrInputDocument buildSolrDocument(BookSearchDocument document) {
        ...
        if (document.getEbookPrice() != null) solrDoc.addField("ebookPrice", document.getEbookPrice());
    ...
    public SolrQuery buildQuery(String queryString, Map<String, String> filters, 
        ...
        if (queryString == null || queryString.trim().isEmpty()) {
            ...
            String multiFieldQuery = String.format(
                "(titleText:%s OR descriptionText:%s OR titleText:%s~1 OR descriptionText:%s~1 OR title:%s OR description:%s)", 
